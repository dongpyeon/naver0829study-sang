...
public class Ex4_ClientChat extends JFrame implements Runnable, ActionListener{
	...
	public void run() {
		...
		try {
			...
			//서버가 언제 메세지를 보낼지 모르므로 while문으로 열어두고 
	...
	private void setDesign() {
		...
		tfNickName=new JTextField("김상우",5);//자기 이름으로 초기값
		tfServerIp=new JTextField("192.168.0.224"); //각자 자기 IP를 초기값으로 지정
