...
public class Ex15_ListStudent {
	List<Student> list = new ArrayList<Student>(); //vector나 arraylist는 동일
	...
	public Ex15_ListStudent() {
		...
		list.add(new Student("김범수",78,"a"));
		list.add(new Student("이경규",89,"b"));
		list.add(new Student("김구라",91,"a"));
//		System.out.println("총 "+list.size()+"명");
	}
	
	//메뉴
	public int getMenu() //멤벼 변수 안쓰는건 static으로
	{
		int num=0;
	...
	public void addStudent()
	{
		...
		int score=0; //문자가 들어갈수도 있기에 try catch사용
		try {
