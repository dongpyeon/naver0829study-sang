...
public class Ex4_SwingButtion extends JFrame{
	JButton btn1,btn2,btn3;

	public Ex4_SwingButtion(String title) {
	...
	class MyColorButton implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource()==btn1)
			{
				Ex4_SwingButtion.this.getContentPane().setBackground(Color.orange);
			}else
			Ex4_SwingButtion.this.getContentPane().setBackground(Color.magenta);
		}
	}
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Ex4_SwingButtion s= new Ex4_SwingButtion("버튼");
