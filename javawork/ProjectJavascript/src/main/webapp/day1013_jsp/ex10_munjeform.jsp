...
<form action="./ex10_munjeread.jsp" method="post">
	<label>
		<input type="radio" name="line" value="10px solid blue" checked="checked">실선
	</label>
	&nbsp;
	<label>
	...
	&nbsp;
	<label>
		<input type="radio" name="line" value="10px double gold">Double선
	</label>
	&nbsp;
	<label>
		<input type="radio" name="line" value="5px groove orange">Groove선
	</label>
	<br><br>
	<h5>사진을 선택해주세요</h5>
