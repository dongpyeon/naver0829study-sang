...
<body>
	...
	<%
		...
		int uploadSize = 1024 * 1024 * 10; // 10 MB (원하는 업로드 파일 크기 제한에 맞게 조정)

		try{
			multiRequest=new MultipartRequest(request, realPath, uploadSize, "utf-8", new DefaultFileRenamePolicy());// 같은 이름으로 업드르될 경우 파일명 뒤에 숫자 붙여줌
		...
		%>
			...
			<img src="../save/<%=uploadName%>" style="madx-width: 400px;">
		<%}catch(Exception e){
